...
function renderTemplatesList() {
    ...
    filtered.forEach(template => {
        const preview = template.template.substring(0, 50) + '...';
        
        html += `
            <div class="template-list-item" onclick="useTemplate('${template.id}')">
                ...
                <div class="template-list-content">
                    ...
                    <div>
                        <span class="template-list-category">${template.category}</span>
                    </div>
                    <div class="template-list-preview">${preview}</div>
                </div>
            </div>
        `;
    });
...
window.resetTemplateFilters = resetTemplateFilters;
